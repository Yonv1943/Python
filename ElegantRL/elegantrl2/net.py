...
class QNetDuel(nn.Module):  # Dueling DQN
    def __init__(self, mid_dim, state_dim, action_dim):
        ...
        self.net_val = nn.Sequential(nn.Linear(mid_dim, mid_dim // 2), nn.ReLU(),
                                     nn.Linear(mid_dim // 2, 1))  # Q value
        self.net_adv = nn.Sequential(nn.Linear(mid_dim, mid_dim // 2), nn.ReLU(),
                                     nn.Linear(mid_dim // 2, action_dim))  # advantage function value 1
...
class QNetTwin(nn.Module):  # Double DQN
    def __init__(self, mid_dim, state_dim, action_dim):
        ...
        self.net_q1 = nn.Sequential(nn.Linear(mid_dim, mid_dim // 2), nn.ReLU(),
                                    nn.Linear(mid_dim // 2, action_dim))  # q1 value
        self.net_q2 = nn.Sequential(nn.Linear(mid_dim, mid_dim // 2), nn.ReLU(),
                                    nn.Linear(mid_dim // 2, action_dim))  # q2 value
...
class QNetTwinDuel(nn.Module):  # D3QN: Dueling Double DQN
    def __init__(self, mid_dim, state_dim, action_dim):
        ...
        self.net_state = nn.Sequential(nn.Linear(state_dim, mid_dim), nn.ReLU(),
                                       nn.Linear(mid_dim, mid_dim), nn.ReLU())
        self.net_val1 = nn.Sequential(nn.Linear(mid_dim, mid_dim // 2), nn.ReLU(),
                                      nn.Linear(mid_dim // 2, 1))  # q1 value
        self.net_val2 = nn.Sequential(nn.Linear(mid_dim, mid_dim // 2), nn.ReLU(),
                                      nn.Linear(mid_dim // 2, 1))  # q2 value
        self.net_adv1 = nn.Sequential(nn.Linear(mid_dim, mid_dim // 2), nn.ReLU(),
                                      nn.Linear(mid_dim // 2, action_dim))  # advantage function value 1
        self.net_adv2 = nn.Sequential(nn.Linear(mid_dim, mid_dim // 2), nn.ReLU(),
                                      nn.Linear(mid_dim // 2, action_dim))  # advantage function value 1
...
class ActorSAC(nn.Module):
    def __init__(self, mid_dim, state_dim, action_dim, if_use_dn=True):
        ...
        self.net_a_avg = nn.Sequential(nn.Linear(out_dim, mid_dim // 2), nn.Hardswish(),
                                       nn.Linear(mid_dim // 2, action_dim))  # the average of action
        self.net_a_std = nn.Sequential(nn.Linear(out_dim, mid_dim // 2), nn.Hardswish(),
                                       nn.Linear(mid_dim // 2, action_dim))  # the log_std of action
...
class CriticTwin(nn.Module):
    def __init__(self, mid_dim, state_dim, action_dim, if_use_dn=False):
        ...
        self.net_q1 = nn.Sequential(nn.Linear(out_dim, mid_dim // 2), nn.ReLU(),
                                    nn.Linear(mid_dim // 2, 1), )
        self.net_q2 = nn.Sequential(nn.Linear(out_dim, mid_dim // 2), nn.ReLU(),
                                    nn.Linear(mid_dim // 2, 1), )
